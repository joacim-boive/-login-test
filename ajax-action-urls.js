...
export const UPDATE_CUSTOMER_ACCOUNT _URL = (customerId, referenceId) => `/rest/customers/v1/${customerId}/accounts/${referenceId}`;
...
export const GET_SESSION_URL = (sessionKey) => `/rest/sessions/v1/${sessionKey}`;

export const DELETE_SESSION_URL = (sessionKey) => `/rest/sessions/v1/${sessionKey}`;

export const CREATE_SESSION_URL = () => '/rest/sessions/v1';
...
export const GET_TEXT_URL = (country, lang, textId) => `/rest/texts/v1/${country}/${lang}/${textId}`;
