...
# ##customer! rekit add action account/getCustomerExtraCardHolders -a
...
# ##customer! rekit add action account/updateCustomerContactInfo -a
# ##customer! rekit add action account/updateCustomerExtraCardHolderContactInfo -a


rekit add action customer/getCustomerExtraCardHolders -a
rekit add action customer/updateCustomerContactInfo -a
rekit add action customer/updateCustomerExtraCardHolderContactInfo -a
