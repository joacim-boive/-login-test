export const GET_CUSTOMER_URL = (customerId, updateFromCreditSystem) => `/rest/customers/v1/${customerId}?update=${updateFromCreditSystem}`; // update=true => get data from ACSX + update NETX
